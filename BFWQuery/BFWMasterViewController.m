...
#import "BFWDetailViewController.h"
...
- (void)viewDidLoad
{
	...
	self.detailViewController = (BFWDetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}
